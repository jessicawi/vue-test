<template>
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <table id="tbl_Portfolios" class="table table-light table-hover">
                        ...
                        <tr v-for="tempobj_Portfolio of arrobj_Portfolios"
                            ...
                            <th scope="row" @click="initSavedPortfolioPostModal(tempobj_Portfolio)">
                                <div>
                                    {{tempobj_Portfolio.PortfolioDesc}}
                                </div>
                            </th>
                            <td @click="initSavedPortfolioPostModal(tempobj_Portfolio)">
            ...
            <div class="col-2">
                <button v-if="!isNull(arrobj_Posts)" @click="initCreatePortfolioModal">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                    Generate Portfolio
                </button>
                <button v-if="!isNull(arrobj_Posts) && !isNull(arrobj_SelectedPortfolios)" @click="showDeleteModal">
        ...
        <b-modal id="modal_CreatePortfolio" hide-footer size="lg" title="Create Portfolio"
                        ...
                        <div class="col-" v-for="tempobj_Post of arrobj_Posts" :key="tempobj_Post.id">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button href="#" @click="showViewPostModal(tempobj_Post, showCreatePortfolioModal)"
            ...
            <div class="row">
                <button id="btn_Cancel" @click="hideGeneratePortfolioModal" class="btn btn-primary">Cancel</button>
                <button id="btn_Next" :disabled="obj_PortFolio.arrobj_SelectedPortfolioPosts.length === 0"
        ...
        <b-modal id="modal_PortfolioDescription" hide-footer size="lg" title="Portfolio Description"
            ...
            <div class="row">
                <button id="btn_Back" class="btn btn-primary" @click="showCreatePortfolioModal">Back</button>
                <button id="btn_Submit" class="btn btn-secondary" @click="generatePortfolio">Submit</button>
            </div>
        </b-modal>
        <b-modal id="modal_SavedPortfolioPost" hide-footer size="lg" title="View Portfolio"
                 ...
                 centered>
            <div class="row">
                <button id="btn_EdtPortfolio" @click="showCreatePortfolioModal" class="btn btn-primary">Edit<i
                        class="fa fa-pencil" aria-hidden="true"></i></button>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="row overflow-x-scroll flex-row flex-nowrap">
                        <div class="col-" v-for="tempobj_Post of obj_PortFolio.arrobj_SelectedPortfolioPosts"
                             :key="tempobj_Post.id">
                            <div class="card">
                                <div class="card-header">
                                    <div class="text-left float-left">
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <p style="white-space: pre-line;">{{obj_PortFolio.PortfolioDesc}}</p>
                </div>
            </div>
        </b-modal>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initSavedPortfolioPostModal(tempobj_Portfolio) {
            ...
            loadPortfolio() {
                DataSource.shared.getPortfolioListByStudentID(this.obj_Student.Student_ID).then((result) => {
            ...
            loadPortfolioPosts() {
                ...
                DataSource.shared.getStudentPostByType(this.obj_Student.Student_ID, this.str_PostType, this.int_NumberOfPost).then((result) => {
                    return result.Table;
