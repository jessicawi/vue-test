    ...
    <div class="container-fluid">
                ...
                <div class="menu">
                    ...
                    <div class="menu-item" v-if="arrobj_SelectedItem.length > 0">
                        <button @click="showPortfolioModal" class="custom-tooltip btn btn-secondary"
                                title="Post as portfolio"><i
                                class="fa fa-eye"></i>
                            <span class="custom-tooltiptext">Post as portfolio</span>
                        </button>
                    </div>
                    <div class="menu-item" v-if="arrobj_SelectedItem.length > 0">
                        <button @click="showUpdateModal" class="custom-tooltip btn btn-secondary"
                                title="Post as Updates"><i
                                class="fa fa-eye"></i>
                            <span class="custom-tooltiptext">Post as Updates</span>
                        </button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row gallery-folder__top">
        ...
        <div class="row ">
            <div class="col-12 bg-white div_ItemContainer">
                <div class="row border-bottom gallery-folder__bottom">
                    <div class="col-">
                ...
                <div class="row gallery-album">
                    ...
                    >
                        ...
                        <input class="limited" type="checkbox" :id="obj_File.GalID" :value="obj_File"
                               v-model="arrobj_SelectedItem" :disabled="isNull(arrobj_SelectedItem.find(x=>x.GalID === obj_File.GalID)) && arrobj_SelectedItem.length >= int_SelectLimit"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            setLimiter() {
                if (this.arrobj_SelectedItem.length >= this.int_SelectLimit)
