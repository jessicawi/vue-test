        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tb_Title" placeholder="Please enter a title" required/>

                    <label for="tb_Observation">Observation</label>
                    <input type="text" class="form-control" id="tb_Observation" placeholder="Please enter your observation" required/>

                    <label>Analysis & reflection</label>
                    <select type="text" class="form-control" id="tb_AnalysisReflection">
                        <option>Option 1</option>
                    </select>

                    <label>Developmental Goals</label>
                    <select type="text" class="form-control" id="tb_Goals">
                        <option>Option 1</option>
                    </select>
            ...
            <div class="col-4">
                <div class="row">
                    <div class="col-12" v-for="obj_Class of arrobj_Classes" :key="obj_Class.id">
                        ...
                        <div class="row">
                            <label class="col- text-center" v-for="obj_Student of obj_Class.ArrObj_Items"
                                ...
                                <input type="radio" :value="obj_Student" v-model="obj_SelectedStudent"
                                       :id="obj_Student.id">
                                <br/>
        ...
        methods: {
            loadStudents() {
                DataSource.shared.getPortfolioStudentClass().then((result) => {
                    this.arrobj_Classes = this.groupBy(result, "CLS_ClassName");
                });
            },
