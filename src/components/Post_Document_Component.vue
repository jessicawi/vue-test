            ...
            <div class="col-6">
                <div>
                    <input type="file" multiple class="inputfile"
                           id="FU_Report"/>
                    <label for="FU_Report">Choose a file</label>
                ...
                <form @submit.prevent="verifyPost">
                    <div class="form-group">
                        <label for="tb_DocContent">Content</label>
                        <textarea v-model="obj_Post.docContent" type="text" class="form-control"
                                  id="tb_DocContent"
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-4">
                            <input type="reset" @click="resetAll" class="btn btn-secondary" value="Cancel"/>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            verifyPost() {
                if (this.isNull(this.obj_Post.docContent)) {
                    this.$emit("result", "FALSE");
                    return;
                }

                DataSource.shared.saveDocumentPost(this.arrobj_SelectedFiles,
                    this.obj_Post.docContent,
        ...
        mounted() {
            ...
            $("#FU_Report").on("change", function (e) {
